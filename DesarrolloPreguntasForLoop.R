...
#PROCEDIMIENTO    
    ...
    #(1) Generar un loop, tal que reconozca al 1er elemento del vector; "mp" o "of".
      # (2) A continuación, generar un filtro para que la maquina pueda contabilizar el número de nombres dentro del vector.
        # (3) Una vez tenga todo los "mp" identificados y el número de nombres, calcular estadísticas.
           # (4) Arrojar mensaje.
